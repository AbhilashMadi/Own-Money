...
const ExpenseCard: FC<IExpenseCard> = (props) => {
  ...
  return (
    <div className="flex gap-4 items-center cursor-pointer p-2">
      <div className="p-4 bg-muted rounded-md">{expenseObj.icon}</div>
      <div className="grow">
  ...
  return (
    <>
      <div className="flex justify-between pb-2 mt-4">
        ...
        <p className="text-sm flex gap-1 items-center text-gray-400">
