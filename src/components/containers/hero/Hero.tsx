    ...
    <section className="bg-hero-pattern dark:bg-hero-dark-pattern my-10 rounded-2xl p-8 space-y-8 bg-cover bg-center">
      ...
      <div className="flex flex-wrap gap-4 xl:gap-0">
        <div className="space-y-5 w-full xl:w-3/4">
          <h1 className="scroll-m-20 text-3xl font-extrabold tracking-tight lg:text-4xl bg-gradient-to-br from-zinc-900 to-neutral-50 dark:to-zinc-900 dark:from-neutral-50 inline-block text-transparent bg-clip-text animate-fade-up">{heroConfig.headline}</h1>
          <p className="leading-6 [&:not(:first-child)]:mt-6 font-mont font-medium animate-fade-up">{heroConfig.description}</p>
        </div>
        <figure className="w-full xl:w-1/4 animate-fade-up">
